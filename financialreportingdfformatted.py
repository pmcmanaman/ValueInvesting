...
def save_self_stocks_info():
    ...
    dictlist.append({'value':'fsly', 'label':'Fastly'})
    dictlist.append({'value':'net', 'label':'Cloudflare'})
    dictlist.append({'value':'ddog', 'label':'Datadog'})
    dictlist.append({'value':'ARKW', 'label':'Ark W'})
